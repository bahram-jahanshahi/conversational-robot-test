...
public class DescribeEnvironmentPhotoTools {
    ...
    @Tool(description = "Describe the environment shown in the photo taken by the robot's camera")
    public RobotResponse describeEnvironmentPhoto(){
        // Logic to analyze the photo and describe the environment
        try {
            var description = describePhotoByOpenAi.execute();
